    ...
    res.send(`
        ...
        <head>
            ...
            <style>
                ...
                .logo { color: #facc15; font-size: 26px; font-weight: 900; letter-spacing: 1px; font-style: italic; text-shadow: 0 0 12px rgba(250, 204, 21, 0.4); }
            ...
            <div class="container">
                ...
                <table>
                    ...
                    <tbody id="leaderboard">
                        <tr><td colspan="5" class="empty-msg">Select a gamemode from above to load results</td></tr>
                    </tbody>
                </table>
            </div>
            <script>
                ...
                async function selectCategory(category) {
                    ...
                    try {
                        ...
                        if (!data || data.length === 0) {
                            tbody.innerHTML = '<tr><td colspan="5" class="empty-msg">No players found in this gamemode yet.</td></tr>';
                            return;
                        }
